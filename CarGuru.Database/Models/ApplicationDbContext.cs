...
namespace CarGuru.Database.Models
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<ManualCallRecords> ManualCallRecords { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ManualCallRecords>(entity =>
            {
            ...
            modelBuilder.Entity<Notifications>(entity =>
            {
                ...
                entity.HasOne(d => d.Type)
                    ...
                    .HasConstraintName("FK_Lookups_Notifications_TypeId");
            });
            ...
            modelBuilder.Entity<ProductSubCategories>(entity =>
            {
                ...
                entity.HasOne(d => d.CreatedBy)
                    ...
                    .HasForeignKey(d => d.CreatedById)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ProductSubCategories_CreatedById_Users_UserId");

                entity.HasOne(d => d.ProductCategory)
                    .WithMany(p => p.ProductSubCategories)
                    .HasForeignKey(d => d.ProductCategoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ProductSubCategories_ProductCategoryId_ProductCategories_SubcontractorId");
            });
            ...
            modelBuilder.Entity<Products>(entity =>
            {
                ...
                entity.HasOne(d => d.ProductSubCategory)
                    ...
                    .HasConstraintName("FK_Products_ProductSubCategoryId_ProductSubCategories_Id");
